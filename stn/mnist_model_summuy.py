...
class CNN(nn.Module):
    def __init__(self, num_output):
        ...
        self.conv3 = nn.Conv2d(20, 1, kernel_size=3)
        self.conv2_drop = nn.Dropout2d()
        self.fc1 = nn.Linear(20, 160)
        self.fc2 = nn.Linear(160, num_output)
...
class UnBoundedGridLocNet(nn.Module):
    ...
    def forward(self, x):
        batch_size = x.size(0)
        points = self.cnn(x)
        return points.view(batch_size, self.grid_height * self.grid_width, 2)
...
if __name__ == '__main__':
    arg = {
        ...
        "image_height": 32,
        "image_width": 100,
        "span_range_height": 0.8,
        "span_range_width": 0.8,
